...
create table if not exists public.avatars (
  ...
  musetalk_prepared boolean default false, -- Whether MuseTalk avatar is prepared for lip-sync
  musetalk_preparation_status text default 'pending' -- 'pending', 'preparing', 'complete', 'failed'
  created_at timestamptz not null default now(),
